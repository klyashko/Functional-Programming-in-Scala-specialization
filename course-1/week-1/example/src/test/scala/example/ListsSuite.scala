...
class ListsSuite {
  ...
  /**
    ...
    */
  @Test
  def `one plus one is two (0pts)`(): Unit = {
    assert(1 + 1 == 2)
  }

  @Test
  def `one plus one is three (0pts)?`(): Unit = {
  ...
  /**
    ...
    */
  @Test
  def `details why one plus one is not three (0pts)`(): Unit = {
  ...
  /**
    ...
    */
  @Test
  def `intNotZero throws an exception if its argument is 0`(): Unit = {
    try {
      intNotZero(0)
  ...
  /**
    ...
    */
  @Test
  def `sum of a few numbers (10pts)`(): Unit = {
    assert(sum(List(1, 2, 0)) == 3)
  }

  @Test
  def `max of a few numbers (10pts)`(): Unit = {
    assert(max(List(3, 7, 2)) == 7)
  }


  @Rule
  def individualTestTimeout = new org.junit.rules.Timeout(1000)
}
